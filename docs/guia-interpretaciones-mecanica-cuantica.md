...
```mermaid
flowchart TD
    A["Interpretaciones cuanticas"] --> B["Instrumentales u operativas"]
    A --> C["Sin colapso"]
    A --> D["Con variables ocultas"]
    A --> E["Colapso objetivo"]
    A --> F["Relacionales e informacionales"]
    A --> G["Retrocausales o temporales"]
    A --> H["Propuestas radicales"]

    B --> B1["Copenhague"]
    B --> B2["Estadistica o de conjunto"]
    B --> B3["Pragmatista"]

    C --> C1["Everett o muchos mundos"]
    C --> C2["Muchos mentes"]
    C --> C3["Historias consistentes"]
    C --> C4["Modales"]

    D --> D1["de Broglie-Bohm"]
    ...
    F --> F1["Relacional"]
    F --> F2["QBism"]
    F --> F3["Ithaca e informacionales"]

    G --> G1["Transaccional"]
    G --> G2["Dos estados / TSVF"]

    H --> H1["Superdeterminismo"]
    H --> H2["Colapso por consciencia"]
```
